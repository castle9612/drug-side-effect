...
num_iterations = [10,100,1000,10000,100000]
learning_rate = [0.000001,0.00001,0.0001,0.001,0.01,0.1,0.3,0.5,0.7,0.9]
...
for adr_name in adr_name_list:
                ...
                for cb in colsample_bytree:
                    for l1 in lambda_l1:
                        ...
                        for fold, (train_idx, valid_idx) in enumerate(k_fold.split(X_final_train, y_final_train)):
                            ...
                            model = LGBMClassifier(num_iterations=n, learning_rate=lr, max_depth=md, colsample_bytree=cb, lambda_l1=l1, objective='binary',metric='auc',random_state=2024)
    ...
    final_model_f1 = RandomForestClassifier(num_iterations=f1_n, learning_rate=f1_lr, max_depth=f1_md, colsample_bytree=f1_cb, lambda_l1=f1_l1, objective='binary',metric='auc',random_state=2024)
    final_model_f1.fit(X_final_train, y_final_train)
    final_model_auc = RandomForestClassifier(num_iterations=auc_n, learning_rate=auc_lr, max_depth=auc_md, colsample_bytree=auc_cb, lambda_l1=auc_l1, objective='binary',metric='auc',random_state=2024)
    final_model_auc.fit(X_final_train, y_final_train)
    final_model_acc = RandomForestClassifier(num_iterations=acc_n, learning_rate=acc_lr, max_depth=acc_md, colsample_bytree=acc_cb, lambda_l1=acc_l1, objective='binary',metric='auc',random_state=2024)
    final_model_acc.fit(X_final_train, y_final_train)
    final_model_rs = RandomForestClassifier(num_iterations=rs_n, learning_rate=rs_lr, max_depth=rs_md, colsample_bytree=rs_cb, lambda_l1=rs_l1, objective='binary',metric='auc',random_state=2024)
    final_model_rs.fit(X_final_train, y_final_train)
    final_model_total = RandomForestClassifier(num_iterations=total_n, learning_rate=total_lr, max_depth=total_md, colsample_bytree=total_cb, lambda_l1=total_l1, objective='binary',metric='auc',random_state=2024)
...
datadatadata = {'adr_name': adr_name_list,
                ...
                'f1_num_iteration': f1_best_n_list,
                ...
                'auc_num_iteration': auc_best_n_list,
                ...
                'acc_num_iteration': acc_best_n_list,
                ...
                'rs_num_iteration': rs_best_n_list,
                ...
                'total_num_iteration': total_best_n_list,
...
file_name = 'test_lgbm_0708_result_4fold_smote_testsize3_' + adr_name + '.csv'
