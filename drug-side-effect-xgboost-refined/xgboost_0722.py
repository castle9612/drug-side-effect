...
dataset = pd. read_csv('../drug-side-effect-shared-datasets/dataset_0722.csv')
print(dataset)
...
target_action_data = dataset.drop(['Name','ApprovalDate','SMILES','DRUGBANK_ID','THROMBOCYTOPENIA'], axis = 1)
